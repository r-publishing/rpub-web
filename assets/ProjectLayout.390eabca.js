import{c as l,a as m,b,r as o,d as s,e as A,f as T}from"./vendor.97e0a001.js";import{$ as f,C as a}from"./CopyText.9d5a362d.js";/* empty css                                               */const n=l(import.meta.url,{modules:[{module:f,specifier:"../../components/CopyText.svelte"}],hydratedComponents:[a],hoisted:[]}),L=m(import.meta.url,"https://r-publishing.github.io/rpub-web");b(async(t,i,r)=>{const d=t.createAstro(L,i,r),{project:e}=d.props,p=[{props:{"data-astro-id":"2T7Y76LA"},children:".Project.astro-2T7Y76LA{width:100%;}.DonateLabel.astro-2T7Y76LA{margin-bottom:0;margin-left:0.6em;}"}];for(const c of p)t.styles.add(c);return o`
